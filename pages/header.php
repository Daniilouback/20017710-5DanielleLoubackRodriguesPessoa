...
<head>
  ...
  <title>Atividade Mapa- Materia de Backend-I</title>
</head>
<body>
<style>
    *{
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <img class="logo" src="./imagens/logo-removebg-preview.png" alt="Logo">
